...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","theme-black","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/Logo_AnnaMarina.png" alt="AnnaMarina - Аксессуары ручной работы">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("opened",function(){$(".hamburger").addClass("is-active")}).bind("closed",function(){$(".hamburger").removeClass("is-active")}),$(".header-carousel").owlCarousel({loop:!0,smartSpeed:700,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],nav:!1,autoplay:!0,responsiveClass:!0,responsive:{0:{items:1},1200:{items:1}}}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).scroll(function(){$(this).scrollTop()>$(window).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$(".box").sameify({min:992,max:3e3}),$("#gallery").unitegallery({theme_enable_preloader:!1,theme_appearance_order:"normal",tiles_space_between_cols:3,lightbox_textpanel_enable_description:!0})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});